...
# such as0 Django’s – or a third-party Python template system – or not. It can generate a 
# PDF file, output XML, create a ZIP file on the fly, anything you want, using whatever
# Python libraries you want.